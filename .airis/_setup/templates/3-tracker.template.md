...
> **Generated From:** Design.md + Scope.md (AI reads both)
...
1. Use the prompt file: `_setup/prompts/4-tracker.prompt.md`
2. AI will read: Design.md → Scope.md (features from §4)
3. AI will generate all tasks with IDs, acceptance criteria, and dependencies

**Do not fill this template manually.** The AI-generated tasks will be more comprehensive and properly reference all source documents.
...
- Scope.md §Z - [Specific goal, boundary, or feature]
...
- Scope.md §4 - Data entities and relationships

**Acceptance Criteria:**
- [ ] All entities from Scope.md §4 included
...
- Design.md §7.2 - Security guidelines
...
- [ ] Password hashing implemented per Design.md §7.2
...
**Blockers:** None  
**References:**
- Scope.md §4 - F-XXX feature details
- Design.md §Y - Technical approach

**Acceptance Criteria:**
- [ ] Feature F-XXX implemented per Scope.md §4 capabilities
