...
> **Location:** Copy this template to your project's `discovery/` folder and fill it out before creating strategy documents.
...
**Example:**
"Operations teams spend 15+ hours per week manually tracking service requests across email, spreadsheets, and phone calls. This leads to missed deadlines, duplicate work, and frustrated stakeholders. Last quarter, 23% of requests missed their SLA due to tracking errors, resulting in customer escalations and lost revenue opportunities."
...
**Example:**
"Operations teams will have a centralized system where all service requests are automatically tracked from submission to completion. Automated reminders will prevent missed deadlines. Real-time dashboards will show workload and bottlenecks. Result: 95% SLA compliance, 50% reduction in manual tracking time, improved stakeholder satisfaction."
...
**Example:**
"We're building a web-based workflow management system that centralizes request tracking, automates task assignment, and provides real-time visibility. The system will integrate with existing email and ERP systems, automatically creating work items and sending notifications. Team members will have a mobile-responsive interface to update status in real-time."
...
**Critical User Journey 1: [Action Name]** (e.g., "Submit service request")
...
**Example:**
"BR-001: After-Hours Processing Rule
- Description: Service requests submitted after 5 PM are processed the next business day
- When it applies: All requests submitted Monday-Friday after 5 PM EST
- Example: Request at 5:30 PM Monday → processed Tuesday
...
**Entity 1: [Entity Name]** (e.g., "Service Request")
...
| Data volume | [e.g., 10,000 transactions/month] | [Scalability testing] |
...
- [ ] **[Industry-specific standard]** (e.g., FDA 21 CFR Part 11, ISO 27001) - [Specific requirements]
